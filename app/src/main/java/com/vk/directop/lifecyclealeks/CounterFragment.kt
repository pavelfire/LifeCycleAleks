...
import com.vk.directop.lifecyclealeks.databinding.FragmentCounterBinding
...
class CounterFragment : Fragment() {
    ...
    private fun launchNext(){
        val fragment = newInstance(
            counterValue = (requireActivity() as HarryActivity).getScreensCount() + 1,
            quote = (requireActivity() as HarryActivity).createQuote()
        )
